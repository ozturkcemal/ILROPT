...
model.constraint=pyo.Constraint(pyo.Any) #this is needed to write constraint labels
...
#model.display() #keep this on to see constraint labels
# Solve the model using MindtPy
#SolverFactory('mindtpy').solve(model, mip_solver='glpk', nlp_solver='ipopt', tee=True)

solver=SolverFactory('gurobi')
solver.options["NonConvex"] = 2 #this is needed i you work with nonlinear quadratic terms in your model, directly with gurobi
