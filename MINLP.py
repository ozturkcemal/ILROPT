...
model.constraint=pyo.Constraint(pyo.Any)
...
for i in I:
    model.constraint["constraint 1.f for facility ",i]=model.s[i]-z*(tou[i]*model.v[i])**0.5>=sum(
                                                                                                tou[i]*d[i,j,k]*model.x[i,j,k] for j in J for k in K
                                                                                           )
